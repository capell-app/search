...
This page is the consolidated implementation overview for the Site Search package. It is extracted from the package README, service providers, migrations, config files, routes, resources, models, actions, and the shared Capell ERD notes where available.
...
Uses a SiteSearch contract and driver classes so search can start with database queries and move to Scout without changing the frontend surface.
...
- Run `vendor/bin/pest packages/site-search/tests` when package tests exist.
- Run the relevant host-app migration or package install flow in a disposable database.
- Open the listed admin or frontend surface and compare it with the screenshot plan.

## Package Manifest

- Composer name: `capell-app/site-search`
...
- Config: packages/site-search/config/capell-site-search.php
- Route file: packages/site-search/routes/web.php
...
- Migration: create_site_search_logs_table.php
- Settings migration: add_site_search_settings.php
...
Deployment should read [screenshots.json](screenshots.json), install the package with demo data, resolve each admin surface or frontend URL, and write images to `public/docs/screenshots/packages/site-search`.
