...
@if ($usesAlpine)
    ...
    >
        <button
            type="button"
            class="hover:text-primary focus:text-primary focus:ring-primary/40 inline-flex h-10 w-10 items-center justify-center rounded-full border border-gray-100 transition focus:outline-none focus:ring-2 dark:border-gray-700"
            x-on:click="
                isSearchOpen = true
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        class="focus:border-primary focus:ring-primary h-11 min-w-0 flex-1 rounded-md border border-gray-200 bg-white px-3 text-sm text-gray-900 shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-1 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
                    />
                    <button
                        type="submit"
                        class="bg-primary focus:ring-primary inline-flex h-11 items-center justify-center rounded-md px-4 text-sm font-medium text-white transition hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                    >
                        {{ __('capell-search::button.search') }}
                    </button>
                    <button
                        type="button"
                        class="hover:text-primary focus:text-primary focus:ring-primary/40 inline-flex h-11 w-11 items-center justify-center rounded-md border border-gray-200 focus:outline-none focus:ring-2 dark:border-gray-700"
